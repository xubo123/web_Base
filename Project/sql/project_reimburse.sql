...
CREATE TABLE `reimburse` (
  ...
  `reim_project` varchar(45) DEFAULT NULL,
  `reim_id` varchar(45) DEFAULT NULL,
  `reim_price` decimal(10,2) DEFAULT NULL,
  `reim_person` varchar(45) DEFAULT NULL,
  `general_ticket_price` decimal(10,1) DEFAULT NULL,
  `return_ticket_date` date DEFAULT NULL,
